...
This is not **R**'s fault. All computers have a limited space to 
...
Now that we know how to preserve our hard-obtained code, we can start doing more elaborate work.
...
**R** doesn't always have a pre-made function to do what we need. But we can write one ourselves and test it easily using a script.
...
Did you see the text I added next to the code? **R** will ignore everything that comes after a hashtag `#`. This `#` is known in **R** as *commenting symbol* because it allows us to comment our code. Comments can explain confusing chunks of code, or warn about potential problems.
