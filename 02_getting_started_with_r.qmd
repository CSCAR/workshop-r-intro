...
However, if an object was the copy of another object, overwriting the original
object does not affect the copy; and overwriting the copy does not affect the
original.
...
different words (`MyObject`). Choose whichever format you like most. Just be
consistent.
