...
`|`, but it can also be any other character. Each file uses only one symbol to
...
Still, it is possible to load Excel files directly if we *really* need to. R has no
